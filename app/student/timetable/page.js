      ...
      <div className="space-y-6">
        ...
        <Card className="bg-card border-border">
          <CardHeader>
            ...
            <CardDescription>All classes for the current semester</CardDescription>
          </CardHeader>
          <CardContent>
        ...
        <Card className="bg-card border-border">
          <CardHeader>
            <CardTitle className="text-card-foreground">Course Details</CardTitle>
            <CardDescription>Information about your enrolled courses</CardDescription>
          </CardHeader>
          <CardContent>
